...
using WorldEvents.Models.AccountViewModels;
...
namespace WorldEvents.Controllers
{
    ...
    {
        private readonly UserManager<ApplicationUser> _userManager; //TODO UserService
        ...
        public IActionResult ExternalLogin(string provider, string returnUrl = null)
        {
            ...
            return new ChallengeResult(provider, properties);            //HttpContext.Authentication.ChallengeAsync("Google",properties);
        }
